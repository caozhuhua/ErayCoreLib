package com.eray.base.utils.excel
{
	...
	public class ErayExcelDataHelper extends EventDispatcher
	{
		...
		/**
		 * 获取活动表格ActivityMain管理类 
		 * @return 
		 * 
		 */		
		public function getActivity_ActivityMainManager():Activity_ActivityMainManager{
			var manager:Activity_ActivityMainManager = null;
			do{
				var obj:Object = this.getSheetsDataByName(DotaSheetsNameData.ACTIVITY_ACTIVITYMAIN);
				if(obj==null){
					break;
				}
				manager = new Activity_ActivityMainManager(obj);
			}while(0);
			return manager;
		}
